...
<div class="row" style="display:none">
            <div class="input-field col s12 m8">
                <?php echo form_dropdown('product', $product, set_value('product',$before->project)); ?>
                 <label> Product</label>
            </div>
        </div>
...
<input type="text" id="Order" name="order" value='<?php echo set_value('order',$before->order);?>'>
 ...
 <div class="row">
   ...
   <div class="row">
      ...
      <span style=" display: block;">305px X 229px</span>
		</div>
<!--
...
-->
        ...
        <div class="row saveclick createbuttonplacement">
				<div class="col m12 s12">
					<button type="submit" class="btn btn-primary waves-effect waves-light blue darken-4">Save</button>
					<a href="<?php echo site_url("site/viewproductimage?id=").$this->input->get("productid");?>" class="waves-effect waves-light btn red">Cancel</a>
				</div>
			</div>
    </form>
</div>
